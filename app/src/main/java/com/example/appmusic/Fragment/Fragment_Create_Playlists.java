...
import com.example.appmusic.Adapter.CreatePlaylistAdapter;
...
//        testList.add("Nguyễn Thị Hải Sơn");
//        testList.add("Nguyễn Thị Hải Sơn");
//        testList.add("Nguyễn Thị Hải Sơn");
//        testList.add("Nguyễn Thị Hải Sơn");
//
...
//        Call<List<Song>> callBack = dataService.getDataBaiHat(); // gọi pthuc trả về mảng các Album
//        callBack.enqueue(new Callback<List<Song>>() {
//            @Override
//            public void onResponse(Call<List<Song>> call, Response<List<Song>> response) {
//                // sự kiện lăng nghe thành công
//                ArrayList<Song> listBaiHat = (ArrayList<Song>) response.body(); // trả về mảng dữ liệu
//                // in ra xem kết quả
